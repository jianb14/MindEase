...
export default function Hero() {
    return (
        <FadeIn>
            <section className="relative overflow-hidden bg-bg-primary h-[75vh] sm:h-screen w-full flex  sm:items-start justify-center px-4 sm:px-10 md:px-20 lg:px-60 pt-16 sm:pt-20">
                ...
                <div className="flex justify-center px-14 md:px-0 gap-2.5 flex-col sm:flex-row">
