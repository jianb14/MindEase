...
export default function Hero() {
    return (
        <section className="relative overflow-hidden bg-bg-primary min-h-screen sm:h-screen w-full flex sm:items-start justify-center px-4 sm:px-10 md:px-20 lg:px-60 pt-16 sm:pt-20">
