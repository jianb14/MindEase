...
export default function WhyChoose() {
    return(
        ...
        <section className="relative bg-bg-primary w-full flex justify-center py-40 px-5 lg:px-10">
            <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 grid-rows-2 gap-6 sm:mx-6 md:mx-10 mx-0">
                    <div className="bg-white z-2 p-7 group rounded-2xl shadow hover:-translate-y-1.75 hover:shadow-lg transition duration-300">
                        <div className="h-12 w-12 flex justify-center items-center bg-blue-ghost rounded-lg mb-5 transition-transform duration-300 group-hover:scale-115">
                            <UserCheck 
                                size={24}
                    ...
                    <div className="bg-white z-2 p-7 group rounded-2xl shadow hover:-translate-y-1.75 hover:shadow-lg transition duration-300">
                        <div className="h-12 w-12 flex justify-center items-center bg-green-ghost rounded-lg mb-5 transition-transform duration-300 group-hover:scale-115">
                            <Sparkles
                                size={24}
                    ...
                    <div className="bg-white z-2 p-7 group rounded-2xl shadow hover:-translate-y-1.75 hover:shadow-lg transition duration-300">
                        <div className="h-12 w-12 flex justify-center items-center bg-orange-ghost rounded-lg mb-5 transition-transform duration-300 group-hover:scale-115">
                            <ClipboardList
                                size={24}
                    ...
                    <div className="bg-white z-2 p-7 group rounded-2xl shadow hover:-translate-y-1.75 hover:shadow-lg transition duration-300">
                        <div className="h-12 w-12 flex justify-center items-center bg-rose-ghost rounded-lg mb-5 transition-transform duration-300 group-hover:scale-115">
                            <Lock
                                size={24}
                                className="text-rose"
                            />
                    ...
                    <div className="bg-white z-2 p-7 group rounded-2xl shadow hover:-translate-y-1.75 hover:shadow-lg transition duration-300">
                        <div className="h-12 w-12 flex justify-center items-center bg-violet-ghost rounded-lg mb-5 transition-transform duration-300 group-hover:scale-115">
                            <ChartColumn
                                size={24}
                    ...
                    <div className="bg-white z-2 p-7 group rounded-2xl shadow hover:-translate-y-1.75 hover:shadow-lg transition duration-300">
                        <div className="h-12 w-12 flex justify-center items-center bg-red-ghost rounded-lg mb-5 transition-transform duration-300 group-hover:scale-115">
                            <Heart
                                size={24}
                                className="text-red"
                            />
