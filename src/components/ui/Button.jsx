...
export default function Button({ children, onClick, to, label, variant = "primary", icon: Icon, className = "" }) {
    ...
    const variants = {
        ...
        accent: "bg-btn-secondary shadow-[0_6px_0_#cfe6fb] dark:shadow-[0_6px_0_#182c50] border border-color-outline text-neutral-600 dark:text-white/80 hover:bg-btn-secondary-hover",
